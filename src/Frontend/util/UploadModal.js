...
function UploadModal({
  ...
  const Fetch = () => {
    axios
      ...
      .then((res) => {
        ...
        if (["PatientSearch"].includes(pageName)) {
          handleUploadCount(
            "UploadDocumentCount",
          ...
          if (
            ["/EditPatientDetails", "/PatientSearch"].includes(
  ...
  const handleUpload = async (e) => {
    ...
    if (generatedError == "") {
      ...
      if (!document.getElementById("file").files[0]) {
        ...
        const names = ["EmployeMaster", "CentreMaster", "RateTypeMaster","PatientSearch"];
  ...
  return (
    <Modal show={show} onHide={handleClose} size="md">
      <Modal.Header className="" style={{background:"#00c0ef"}}>
      ...
      <Modal.Body>
        <div className="box_Container" id="DocModalData">
          <div className="box-header with-border box_header">
            {["PatientSearch"].includes(pageName) && (
          ...
          <div className="box-body">
              ...
              <div className="form-group has-feedback col-sm-12">
                {options && (
                  <div style={{width:"auto"}}>
                    ...
                    >
                      <option hidden style={{width:"10px"}}>{t("Select")}</option>
            ...
            <div
              className={`box-body table-responsive  ${tableData.length > 8 ? "boottable" : ""
                }`}
            >
              {tableData.length > 0 && (
                <table
