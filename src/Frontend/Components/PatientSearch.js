            ...
            <div className="box-body">
                <div className="contain" style={{ background: "white" }}>
                    <div className="searchtitle" style={{ background: "#00c0ef", height: "35px", display: "flex", justifyContent: "space-between" }}>
                        ...
                        <div>
                            <i className="fa fa-sign-out" style={{ fontSize: "18px", marginTop: "9px", textAlign: "end", cursor: "pointer", marginRight: "12px" }} onClick={handleLogout}></i>
                        </div>
                    </div>
                </div>
                <div
                        ...
                        {tabledata.length > 0 && (
                            <div className="box" style={{marginTop:"10px"}}>
                                ...
                                <div className="" style={{ paddingBottom: "5px" }}>
                                    ...
                                    >
                                        <table
                                            className="table table-bordered table-hover table-striped divResult"
                                            cellPadding="{0}"
                                            cellSpacing="{0}"
                                    ...
                                    {/* <i className="fa fa-camera" style={{ fontSize: "40px", marginLeft: "10px", marginTop: "7px" }}></i>

                                    <i className="fa fa-file" style={{ fontSize: "35px", marginTop: "9px", marginLeft: "60PX" }}></i> */}
                                    <div style={{ margin: "8px" }}>
                                        <button
                                            type="submit"
                                            className="btn btn-custom-01 btn-block btn-flat btn-info"
                                            style={{ borderRadius: "20px", marginTop: "10px", marginBottom: "20px" }}
